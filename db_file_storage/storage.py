...
class DatabaseFileStorage(Storage):
    def __init__(self):
        ...
        def get_model_wrapper(self, app_label, model_name):
            return get_model(app_label, model_name)
        self._get_model = get_model_wrapper
    ...
    def _save(self, name, content):
        ...
        model_class = self._get_model_class(model_class_path)
        new_filename = _self.get_unique_filename(model_class, filename_field, name)
